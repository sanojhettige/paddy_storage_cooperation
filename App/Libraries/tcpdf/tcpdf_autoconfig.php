...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'COOL GARDEN PVT LTD');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'COOL GARDEN PVT LTD');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'COOL GARDEN PVT LTD');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "COOL GARDEN PVT LTD ");
}
