...
<form method="post" action="">
  ...
  <div class="form-group">
    ...
    <input value="<?= get_post('city') ? get_post('city') : ($record ? $record['city'] : ''); ?>" type="text" class="form-control" required id="city" name="city" placeholder="">
  ...
  <div class="form-group">
    ...
    <input value="<?= get_post('capacity') ? get_post('capacity') : ($record ? $record['capacity'] : ''); ?>" type="number" class="form-control" required id="capacity" name="capacity" placeholder="">
