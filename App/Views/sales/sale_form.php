    ...
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" required
                value="<?= get_post('collection_date') ? get_post('collection_date') : ($record['issue_date'] ? date("Y-m-d", strtotime($record['issue_date'])) : ''); ?>"
    ...
    <div class="row">
                    ...
                    <tr class="saleItem">
                        ...
                        <td>
                            <span class="input-group-prepend">
                                <input class="form-control" value="<?= $row['sold_rate']; ?>" readonly type="number"
                                    name="item[price][]">
                            ...
                            <input class="form-control" value="<?= $row['sold_amount']; ?>" type="hidden"
                                name="item[qty_org][]">
                        </td>
                        <td></td>
                        <td>
        ...
        <div class="col-md-12">
            ...
            <textarea class="form-control" id="notes" name="notes"
                rows="4"><?= get_post('notes') ? get_post('notes') : (isset($record['sales_notes']) ? $record['sales_notes'] : ''); ?></textarea>
