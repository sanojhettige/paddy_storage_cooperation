...
<div class="row component-header">
    ...
    <div class="col-md-4">
        <a href="/settings/paddy_categories" class="btn btn-success btn-sm pull-right"> Add New </a>
    </div>
</div>
<?php } ?>
...
<div class="row">
    <div class="col-md-8">
        <div class="table-responsive">
            <table id="categories_datatable" class="table table-striped table-sm" url="/settings/get_paddy_categories">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Name</th>
