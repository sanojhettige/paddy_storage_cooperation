<div class="row component-header">
    ...
    <div class="col-md-4">
        <a href="#" data-toggle="modal" data-target="#modal-add-price" class="btn btn-success btn-sm pull-right addPrice"> Add New </a>
    </div>
</div>
<div>
    ...
    <div class="modal-content">
      <form id="dailyPriceForm" method="post" action="/settings/save_price">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <label>Date</label>
            <input type="text" required class="form-control datetimepicker" id="date" data-date-format="yyyy-mm-dd" name="date">
          </div>
          <div class="form-group">
