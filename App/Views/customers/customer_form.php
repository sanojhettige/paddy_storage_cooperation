...
<form method="post" action="">
  ...
  <div class="form-group">
    ...
    <input value="<?= get_post('company_name') ? get_post('company_name') : ($record ? $record['company_name'] : ''); ?>" type="text" class="form-control" required id="company_name" name="company_name" placeholder="">
  ...
  <div class="form-group">
    ...
    <input value="<?= get_post('email_address') ? get_post('email_address') : ($record ? $record['email_address'] : ''); ?>" type="email" class="form-control" required id="email_address" name="email_address" placeholder="">
