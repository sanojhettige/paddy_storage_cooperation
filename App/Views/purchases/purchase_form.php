...
<form method="post" action="" id="purchaseForm">
  ...
  <div class="form-group col-md-4">
    ...
    <input type="text" required value="<?= get_post('collection_date') ? get_post('collection_date') : ($record['collection_date'] ? date("Y-m-d", strtotime($record['collection_date'])) : ''); ?>" class="form-control datetimepicker" id="collection_date" data-date-format="yyyy-mm-dd" name="collection_date">
          ...
          <table class="table">
            ...
            <tbody class="itemList">
              ...
              <tr class="purchaseItem">
                  ...
                  <td>
                    <input class="form-control" value="<?= $row['collected_amount']; ?>" type="number" name="item[qty][]">
                  </td>
                  <td>
                  <span class="input-group-prepend">
                    <input class="form-control" value="<?= $row['collected_rate']; ?>" readonly type="number" name="item[price][]">
                  ...
                  <input class="form-control" value="<?= $row['collected_amount']; ?>" type="hidden" name="item[qty_org][]">
                  </td>
                  <td></td>
                  <td>
    ...
    <textarea class="form-control" id="notes" name="notes" rows="4"><?= get_post('notes') ? get_post('notes') : ($record ? $record['purchase_notes'] : ''); ?></textarea>
