<form method="post" action="" id="transferForm">
    <div class="row">
        <div class="form-group col-md-4">
            ...
            <span
                class="error-message from_center_id"><?= isset($errors["from_center_id"]) ? $errors["from_center_id"]: ""; ?></span>
        </div>
        <div class="form-group col-md-4">
            ...
            <span
                class="error-message to_center_id"><?= isset($errors["to_center_id"]) ? $errors["to_center_id"]: ""; ?></span>
        </div>
        <div class="form-group col-md-4">
            <label for="transfer_date">Transfer Date</label>
            <input type="text" required
                value="<?= get_post('transfer_date') ? get_post('transfer_date') : ($record['transfer_date'] ? $record['transfer_date'] : ''); ?>"
                class="form-control datetimepicker" id="transfer_date" data-date-format="yyyy-mm-dd"
                name="transfer_date">
            <span
                class="error-message transfer_date"><?= isset($errors["transfer_date"]) ? $errors["transfer_date"]: ""; ?></span>
        </div>
        <div class="form-group col-md-6">
            ...
            <span
                class="error-message vehicle_id"><?= isset($errors["vehicle_id"]) ? $errors["vehicle_id"]: ""; ?></span>
        </div>
        <div class="form-group col-md-6">
