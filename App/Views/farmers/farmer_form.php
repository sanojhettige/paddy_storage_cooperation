<form method="post" action="">
    ...
    <div class="form-group">
        ...
        <input value="<?= get_post('land_size') ? get_post('land_size') : ($record ? $record['land_size'] : ''); ?>"
            type="text" class="form-control" required id="land_size" name="land_size" placeholder="">
